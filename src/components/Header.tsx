      ...
      <div className="w-full max-w-[1300px] h-full flex justify-between items-center border-b border-white/6">
        ...
        <div className="relative mr-1.5 w-[170px] min-w-[170px] h-10 rounded-[40px] bg-[#121a2e] flex items-center transition-all duration-300 cursor-pointer hover:opacity-70">
          <div className="w-10 h-10 rounded-[40px] bg-gradient-to-br from-[#fefe75] to-[#fed630] flex justify-center items-center mr-2.5">
            <div className="absolute w-14 pointer-events-none">🎁</div>
          </div>
          <div className="h-full flex flex-col justify-center">
            <span className="font-bold italic text-sm text-white leading-none">
              Post a
            </span>
            <span className="font-extrabold italic text-sm gradient-text leading-none">
              Job
            </span>
          </div>
          <svg
          ...
          <div className="flex justify-center items-center gap-2">
            <div className="relative cursor-pointer">
              <div className="w-12 h-12 bg-gradient-to-b from-[#0d1529] to-[#141c30] border-2 border-[#4383ff] rounded-full flex justify-center items-center">
                ...
                >
                  <path
                    d="M7 0C5.06771 0 3.5 1.6317 3.5 3.64286C3.5 5.65402 5.06771 7.28571 7 7.28571C8.93229 7.28571 10.5 5.65402 10.5 3.64286C10.5 1.6317 8.93229 0 7 0ZM5.25 8.5C2.34245 8.5 0 10.9381 0 13.9643V14.5714C0 15.9185 1.03906 17 2.33333 17H11.6667C12.9609 17 14 15.9185 14 14.5714V13.9643C14 10.9381 11.6576 8.5 8.75 8.5H5.25Z"
                    fill="white"
                  />
                </svg>
              </div>
              <div className="absolute bottom-0 right-0 w-[18px] h-[18px] bg-[#4383ff] rounded-xl flex justify-center items-center transition-all duration-300 hover:bg-[#2c62c9]">
                ...
                >
                  <path
                    d="M1 1L3.57031 3.85714C3.706 4.00406 3.8141 4.1812 3.88797 4.37771C3.96184 4.57423 4 4.786 4 5C4 5.214 3.96184 5.42577 3.88797 5.62234C3.8141 5.81886 3.706 5.99594 3.57031 6.14286L1 9"
                    stroke="white"
                    strokeWidth="2"
                    strokeLinecap="round"
            ...
            <div className="ml-1 flex flex-col gap-1">
              <div className="whitespace-nowrap font-bold text-sm text-white/25">
                Wallet
              </div>
              <div className="whitespace-nowrap font-bold text-lg leading-5 text-white">
                $252<span className="opacity-25">.40</span>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              >
                <div className="relative">
                  ...
                  >
                    <path
                      d="M20.6316 16.9904L19.5915 15.2639C19.3731 14.8791 19.1755 14.1511 19.1755 13.7246V11.0933C19.1755 8.6491 17.7402 6.53777 15.6704 5.5497C15.1296 4.59284 14.1311 4 12.9871 4C11.8534 4 10.8342 4.61364 10.2933 5.5809C8.26518 6.58977 6.86109 8.68031 6.86109 11.0933V13.7246C6.86109 14.1511 6.66348 14.8791 6.44507 15.2535L5.3946 16.9904C4.97857 17.6873 4.88496 18.4569 5.14498 19.1642C5.3946 19.861 5.98744 20.4019 6.75709 20.6619C8.77482 21.3483 10.8966 21.6812 13.0183 21.6812C15.14 21.6812 17.2617 21.3483 19.2795 20.6723C20.0075 20.4331 20.5691 19.8818 20.8396 19.1642C21.11 18.4465 21.0372 17.6561 20.6316 16.9904Z"
                      fill="#404B66"
                    />
                    <path
                      d="M15.9389 22.692C15.5021 23.8985 14.3476 24.7618 12.9955 24.7618C12.1738 24.7618 11.3626 24.429 10.7905 23.8361C10.4577 23.5241 10.2081 23.1081 10.0625 22.6816C10.1977 22.7024 10.3329 22.7128 10.4785 22.7336C10.7177 22.7648 10.9674 22.796 11.217 22.8168C11.8098 22.8689 12.4131 22.9001 13.0163 22.9001C13.6091 22.9001 14.202 22.8689 14.7844 22.8168C15.0028 22.796 15.2212 22.7856 15.4293 22.7544C15.5957 22.7336 15.7621 22.7128 15.9389 22.692Z"
                      fill="#404B66"
                    />
                    <circle
                      cx="20.5"
                ...
                <div className="absolute top-[70px] right-0 w-[340px] bg-[#090f1e] border border-[#181d2b] rounded-xl flex flex-col p-5 z-[1000]">
                  <div className="w-full flex justify-between items-center mb-5">
                    <div className="flex justify-center items-center gap-2.5">
                      ...
                      >
                        <path
                          d="M15.6316 12.9904L14.5915 11.2639C14.3731 10.8791 14.1755 10.1511 14.1755 9.72464V7.09326C14.1755 4.6491 12.7402 2.53777 10.6704 1.5497C10.1296 0.592839 9.13113 0 7.98705 0C6.85338 0 5.83415 0.61364 5.29332 1.5809C3.26518 2.58977 1.86109 4.68031 1.86109 7.09326V9.72464C1.86109 10.1511 1.66348 10.8791 1.44507 11.2535L0.394597 12.9904C-0.0214298 13.6873 -0.115036 14.4569 0.144981 15.1642C0.394598 15.861 0.987436 16.4019 1.75709 16.6619C3.77482 17.3483 5.89656 17.6812 8.01826 17.6812C10.14 17.6812 12.2617 17.3483 14.2795 16.6723C15.0075 16.4331 15.5691 15.8818 15.8396 15.1642C16.11 14.4465 16.0372 13.6561 15.6316 12.9904Z"
                          fill="#404B66"
                        />
                        <path
                          d="M10.9389 18.692C10.5021 19.8985 9.34759 20.7618 7.9955 20.7618C7.17385 20.7618 6.3626 20.429 5.79055 19.8361C5.45773 19.5241 5.20811 19.1081 5.0625 18.6816C5.19771 18.7024 5.33292 18.7128 5.47853 18.7336C5.71774 18.7648 5.96737 18.796 6.21699 18.8168C6.80982 18.8689 7.41306 18.9001 8.0163 18.9001C8.60914 18.9001 9.20198 18.8689 9.78442 18.8168C10.0028 18.796 10.2212 18.7856 10.4293 18.7544C10.5957 18.7336 10.7621 18.7128 10.9389 18.692Z"
                          fill="#404B66"
                        />
                      </svg>
                      <span className="font-bold text-sm leading-[17px] text-white">
                        Messages
                      </span>
                    </div>
                    <div
                  ...
                  <div className="w-full flex justify-between items-center mb-5">
                    <span className="font-bold text-sm leading-[17px] text-[#5f6889]">
                      New
                    </span>
                    <span className="font-bold text-sm leading-[17px] text-white transition-all duration-300 cursor-pointer hover:text-[#5f6889]">
                      View all
                    </span>
                  </div>
                      ...
                      <div className="relative w-full p-5 pr-[60px] bg-[#0d1529]">
                        ...
                        <div className="pl-[60px]">
                          <div className="font-bold text-sm text-white mb-4">
                            New order from @client_user
                          </div>
                          <div className="font-bold text-sm text-[#5f6889] word-break">
                            Your Discord bot development service has a new
                            order. Check your dashboard to get started.
                          </div>
                        </div>
                      </div>
                    </div>
