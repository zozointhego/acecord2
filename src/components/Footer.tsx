      ...
      <div className="w-full max-w-[1300px]">
        ...
        <div className="flex justify-between items-start mb-11">
          <div className="flex flex-col gap-3.5">
            ...
            <FooterLink text="Browse Services" />
            <FooterLink text="Categories" />
            <FooterLink text="Post a Job" />
            <FooterLink text="Become a Seller" />
          </div>
          <div className="flex flex-col gap-3.5">
            <div className="font-bold text-base leading-[19px] text-white mb-1.5">
              Support
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="font-bold text-sm leading-[17px] text-[#6f7d9d] text-center">
            © 2025 ACECORD | All Rights Reserved.
          </div>

          <div className="max-w-[1300px] font-medium text-sm leading-[17px] text-[#5f6889]/60 text-center">
            Acecord connects Discord server owners with verified freelance
            experts for moderation, bot development, server setup, and community
            growth.
          </div>

          <div className="font-bold text-sm leading-[17px] text-[#5f6889]/60 text-center">
            Support <span className="text-white">help@acecord.com</span> |
            Business <span className="text-white">business@acecord.com</span> |
            Press <span className="text-white">press@acecord.com</span>
          </div>
        </div>
      </div>
    </div>
